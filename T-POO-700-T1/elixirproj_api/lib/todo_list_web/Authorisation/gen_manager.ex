defmodule TodolistWeb.Plug.Authorisation.AuthGenManager do
  @moduledoc """
  ...
  def call(conn, opts \\ []) do
    check_gen_manager(conn, opts)
  end

  defp check_gen_manager(conn, _opts) do
    current_user = Guardian.Plug.current_resource(conn)
    case Repo.get_by(User, %{id: current_user.id, role: 3}) do
      nil -> halt_plug(conn)
